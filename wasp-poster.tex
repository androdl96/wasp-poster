...
% Un-comment the four lines below ONLY if you have MinionPro and MyriadPro installed on your TeX system.
...
\headerbox{}{name=foottext, column=0, span=2, above=bottom, textborder=none, headerborder=none, headershape=rectangle, headershade=plain, boxshade=plain, boxheaderheight=0pt, boxColorOne=wasp_banner_dark, borderColor=wasp_banner_dark, headerColorOne=wasp_banner_dark, boxpadding=0.5cm}{%
	\hfill\includegraphics[height=1cm]{waspwhite}%
}
